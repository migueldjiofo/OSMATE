...
fun OsmateMapView(
    ...
    val lastCenteredRouteGeoJson = remember {
        mutableStateOf<String?>(null)
    }
    ...
    AndroidView(
        ...
        update = { view ->
            view.getMapAsync { map ->
                ...
                if (
                    routeGeoJson.isNotBlank() &&
                    routeGeoJson != lastCenteredRouteGeoJson.value
                ) {
                    centerMapOnRoute(
                        map = map,
                        routeGeoJson = routeGeoJson,
                    ...
                    lastCenteredRouteGeoJson.value = routeGeoJson
                }
...
private fun centerMapOnRoute(
    ...
    val coordinates = extractCoordinates(routeGeoJson)
    ...
    /*
     * DE: Die gesamte Route wird mit einem Kartenrand angezeigt.
     * FR : L'intégralité de l'itinéraire est affichée avec une marge.
     */
    map.animateCamera(
